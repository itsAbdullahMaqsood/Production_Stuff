...
class MapsViewModel extends ChangeNotifier {
  ...
  Future<void> addDefaultMarker() async {
    ...
    final marker = Marker(
      ...
      infoWindow: InfoWindow(
        ...
        snippet: '${point.latitude.toStringAsFixed(5)}, ${point.longitude.toStringAsFixed(5)}',
      ),
  ...
  Future<void> addCustomMarker() async {
    ...
    final marker = Marker(
      markerId: MarkerId(id),
      position: point,
      icon: _customIcon ?? BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueViolet),
      infoWindow: InfoWindow(
